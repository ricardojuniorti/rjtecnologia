...
<html class="wow-animation" lang="pt-br">
  ...
  <body>
    ...
    -->
    <!-- Page-->
    <div class="page text-center" id="principal">
      <!-- Page Head-->
      <header class="page-head slider-menu-position" data-preset='{"title":"Header with slider","category":"header, slider","reload":true,"id":"header-1"}'>
              ...
              <div class="rd-navbar-top-panel context-dark bg-danger">
                ...
                <div class="right-side">
                  <ul class="list-inline list-inline-sm">
                    <li class="list-inline-item"><a class="novi-icon fa fa-linkedin" href="https://www.linkedin.com/in/ricardo-junior-74058148/" target="_blank"></a></li>
        ...
        <div id="principal" class="swiper-container swiper-slider" data-loop="false" data-autoplay="5500" data-dragable="false">
          <div class="swiper-wrapper text-center">
            <div class="swiper-slide" data-slide-bg="images/1.jpeg" data-preview-bg="images/1.jpeg">
            ...
            <div class="swiper-slide" data-slide-bg="https://source.unsplash.com/random/1920x750/?gamer" data-preview-bg="https://source.unsplash.com/random/1920x750/?gamer">
              <div class="swiper-caption swiper-parallax" data-speed="0.5" data-fade="true">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-xl-center">
            ...
            <div class="swiper-slide" data-slide-bg="https://source.unsplash.com/random/1920x750/?php" data-preview-bg="https://source.unsplash.com/random/1920x750/?php">
              <div class="swiper-caption swiper-parallax" data-speed="0.5" data-fade="true">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-xl-center">
                      <div class="col-xl-12">
                        <div class="text-extra-big font-weight-bold font-italic text-uppercase" data-caption-animate="fadeInUp" data-caption-delay="300"><h1>Praticidade e Performance</h1></div>
                      </div>
                      <div class="col-xl-8 offset-top-10">
                        <h5 class="hidden d-sm-block text-light" data-caption-animate="fadeInUp" data-caption-delay="500">Esse tipo de desenvolvimento de software faz com que sua empresa não precise se adequar a algo já existente</h5>
                        <div class="offset-top-20 offset-sm-top-50"><a class="btn btn-danger btn-anis-effect" href="#servicos" data-waypoint-to="#welcome" data-caption-animate="fadeInUp" data-caption-delay="800"><span class="btn-text">Saiba mais...</span></a></div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="row justify-content-center grid-group-lg offset-top-98">
            <div class="col-md-8 col-lg-4">
              ...
              <div class="box-icon box-icon-bordered"><span class="novi-icon icon icon-outlined icon-sm icon-dark-filled mdi mdi-account-multiple"></span>
                <h4 class="text-danger offset-top-20">Qualidade comprovada!</h4>
                <p>100% de satisfação dos clientes</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Servicos-->
      <section id="servicos" data-preset='{"title":"Carousel 1","category":"content, carousel","reload":true,"id":"carousel-1"}'>
        <h1>Serviços</h1>
      ...
      <!-- Clientes-->
      <section id="clientes" class="section-98 section-md-110 novi-background" data-preset='{"title":"Team","category":"content, team","reload":false,"id":"team"}'>
        <div class="container">
          <h1>Clientes</h1>
              ...
              <h1>Entre em contato conosco</h1>
                ...
                <div class="row justify-content-sm-center">
                  <div class="col-md-8">
                    ...
                    <div class="owl-carousel owl-carousel-testimonials-2" data-items="1" data-nav="false" data-dots="false" data-nav-class="[&quot;owl-prev mdi mdi-chevron-left&quot;, &quot;owl-next mdi mdi-chevron-right&quot;]">
                      <div>
